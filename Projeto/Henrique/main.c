...
{
    char *tabuleiro[16] = {NULL}, eixoletras[16]={0}, input[25]={0}, *dicionario = "/usr/share/dict/words", *letras = "letras.txt", *use_tabuleiro = NULL, *escrever = NULL, *registar_alg = {NULL};
    ...
    {
        get_tabuleiro(tabuleiro, use_tabuleiro, num_linhas);
    }else
    {
