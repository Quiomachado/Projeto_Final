...
int main(int argc, char *argv[])
{
    ...
    int eixonum[16]={0}, num_linhas = 9, n_letras = 0, max_jogadas = -1, modo = 1, linhas = 0, flag = 0, pontos = 0, pontos_totais = 0, jogada = 0;
    ...
    {
        while(alg_cpu(tabuleiro, num_linhas, dicionario_org, linhas, palavra, jogada, &pontos, max_jogadas) == 0)
        {
            pontos_totais += pontos;
